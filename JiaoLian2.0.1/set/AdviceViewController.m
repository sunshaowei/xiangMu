...
//    NSLog(@"=========%@",YIJIAN_FANKUI_URL);
    ...
    NSString*sign=[MD5 stringToMD5Str:[NSString stringWithFormat:@"/rest/native/coach/ol/inrFreed%@%@",userid,token]];
    NSString * postString =[NSString stringWithFormat:@"f_content=%@&id=%@&way=%@&sign=%@",_textView.text,userId,_phoneEmailField.text,sign];
